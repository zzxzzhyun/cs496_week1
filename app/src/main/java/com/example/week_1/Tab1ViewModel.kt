...
class Tab1ViewModel(
    ...
    var allNumbers : MutableLiveData<ArrayList<ListViewItem>> = MutableLiveData()

    fun getPhoneNumbers(sort:String, searchName:String?) : ArrayList<ListViewItem> {
        var list : ArrayList<ListViewItem> = ArrayList<ListViewItem>()
